...
//			let fileExtension = UTTypeCopyPreferredTagWithClass(resource.uniformTypeIdentifier as CFString, UTTagClass.filenameExtension as! CFString)?.takeRetainedValue()
//				
...
//			guard let imageDestination = CGImageDestinationCreateWithURL(destinationURL as CFURL, imageURL.contains(.image) as! CFString, 1, nil),
